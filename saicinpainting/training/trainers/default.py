...
class DefaultInpaintingTrainingModule(BaseInpaintingTrainingModule):
    ...
    def forward(self, batch):
        ...
        #print(collections.Counter(mask.flatten()))
        #pdb.set_trace()
        
        #show_dataloader(img, 'img_', normalize=True) 
        #show_dataloader(masked_img, 'masked_img_', normalize=True) 
        #show_dataloader(mask, 'mask_', normalize=False) 
        ...
        #pdb.set_trace()
        #show_dataloader(batch['predicted_image'], 'predicted_image_', normalize=True)  
        #show_dataloader(batch['image'], 'image_', normalize=True)  
        #show_dataloader(batch['inpainted'], 'inpainted_', normalize=True)  
        #show_dataloader(batch['mask'], 'mask_', normalize=False) 
        #show_dataloader(batch['mask_for_losses'], 'mask_for_losses_', normalize=False) 
